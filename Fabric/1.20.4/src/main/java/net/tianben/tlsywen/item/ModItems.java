...
public class ModItems {
    ...
    //注册装备
    private static final ArmorMaterial material = ModArmorMaterials.DRAGON_CRYSTAL;
    public static final Item DRAGON_CRYSTAL_HELMET = registerItem("dragon_crystal_helmet",
            new ModArmorItem(material, ArmorItem.Type.HELMET, new FabricItemSettings()));
    public static final Item DRAGON_CRYSTAL_CHESTPLATE = registerItem("dragon_crystal_chestplate",
            new ModArmorItem(material, ArmorItem.Type.CHESTPLATE, new FabricItemSettings()));
    public static final Item DRAGON_CRYSTAL_LEGGINGS = registerItem("dragon_crystal_leggings",
            new ModArmorItem(material, ArmorItem.Type.LEGGINGS, new FabricItemSettings()));
    public static final Item DRAGON_CRYSTAL_BOOTS = registerItem("dragon_crystal_boots",
            new ModArmorItem(material, ArmorItem.Type.BOOTS, new FabricItemSettings()));
