...
import static net.minecraft.item.ItemGroup.getTabTextureId;
...
public class ModItemGroups {
    ...
    static final Identifier BACKGROUND = getTabTextureId("tlsywen_items");
