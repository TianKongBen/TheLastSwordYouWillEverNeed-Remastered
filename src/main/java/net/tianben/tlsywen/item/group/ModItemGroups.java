...
public class ModItemGroups {
    public static final RegistryKey<ItemGroup> THE_LAST_SWORD_YOU_WILL_EVER_NEED_GROUP = RegistryKey.of(RegistryKeys.ITEM_GROUP, TheLastSwordYouWillEverNeed.ID("the_last_sword_you_will_ever_need"));
    ...
    public static final ItemGroup the_last_sword_you_will_ever_need = Registry.register(Registries.ITEM_GROUP,
            ...
            FabricItemGroup.builder().displayName(Text.translatable("itemgroup.the_last_sword_you_will_ever_need").formatted(Formatting.WHITE))
