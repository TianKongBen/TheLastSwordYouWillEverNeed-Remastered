...
public class LDlv10Entity extends ThrownItemEntity {
    public LDlv10Entity(EntityType<? extends ThrownItemEntity> entityType, World world) {
        super(entityType, world);
    }

    public LDlv10Entity(LivingEntity livingEntity, World world) {
        super(ModEntities.LDlv10, livingEntity, world);
    }

    @Override
    protected Item getDefaultItem() {
        return ModItems.THELASTSWORDYOUWILLEVERNEEDLV10;
    }
    ...
    protected void onEntityHit(EntityHitResult entityHitResult) {
        if(!this.getWorld().isClient()){
            ...
            entity.damage(this.getDamageSources().thrown(this, entity2), 8800f);
