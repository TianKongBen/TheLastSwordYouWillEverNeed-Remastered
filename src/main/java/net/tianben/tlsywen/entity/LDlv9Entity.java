...
public class LDlv9Entity extends ThrownItemEntity {
    public LDlv9Entity(EntityType<? extends ThrownItemEntity> entityType, World world) {
        super(entityType, world);
    }

    public LDlv9Entity(LivingEntity livingEntity, World world) {
        super(ModEntities.LDlv9, livingEntity, world);
    }

    @Override
    protected Item getDefaultItem() {
        return ModItems.THELASTSWORDYOUWILLEVERNEEDLV9;
    }
    ...
    protected void onEntityHit(EntityHitResult entityHitResult) {
        if(!this.getWorld().isClient()){
            ...
            entity.damage(this.getDamageSources().thrown(this, entity2), 8000f);
