...
public class LDlv1Entity extends ThrownItemEntity {
    public LDlv1Entity(EntityType<? extends ThrownItemEntity> entityType, World world) {
        super(entityType, world);
    }

    public LDlv1Entity(LivingEntity livingEntity, World world) {
        super(ModEntities.LDlv1, livingEntity, world);
    }
    ...
    protected void onEntityHit(EntityHitResult entityHitResult) {
        if(!this.getWorld().isClient()){
            ...
            entity.damage(this.getDamageSources().thrown(this, entity2), 1600f);
