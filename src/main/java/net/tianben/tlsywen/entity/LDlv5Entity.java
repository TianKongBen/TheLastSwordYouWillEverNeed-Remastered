...
public class LDlv5Entity extends ThrownItemEntity {
    public LDlv5Entity(EntityType<? extends ThrownItemEntity> entityType, World world) {
        super(entityType, world);
    }

    public LDlv5Entity(LivingEntity livingEntity, World world) {
        super(ModEntities.LDlv5, livingEntity, world);
    }

    @Override
    protected Item getDefaultItem() {
        return ModItems.THELASTSWORDYOUWILLEVERNEEDLV5;
    }
    ...
    protected void onEntityHit(EntityHitResult entityHitResult) {
        if(!this.getWorld().isClient()){
            ...
            entity.damage(this.getDamageSources().thrown(this, entity2), 4800f);
