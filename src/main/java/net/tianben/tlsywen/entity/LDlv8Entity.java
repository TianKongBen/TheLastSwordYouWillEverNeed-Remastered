...
public class LDlv8Entity extends ThrownItemEntity {
    public LDlv8Entity(EntityType<? extends ThrownItemEntity> entityType, World world) {
        super(entityType, world);
    }

    public LDlv8Entity(LivingEntity livingEntity, World world) {
        super(ModEntities.LDlv8, livingEntity, world);
    }

    @Override
    protected Item getDefaultItem() {
        return ModItems.THELASTSWORDYOUWILLEVERNEEDLV8;
    }
    ...
    protected void onEntityHit(EntityHitResult entityHitResult) {
        if(!this.getWorld().isClient()){
            ...
            entity.damage(this.getDamageSources().thrown(this, entity2), 7200f);
