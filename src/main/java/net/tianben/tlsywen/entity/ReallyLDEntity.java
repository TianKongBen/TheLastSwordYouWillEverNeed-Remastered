...
public class ReallyLDEntity extends ThrownItemEntity {
    public ReallyLDEntity(EntityType<? extends ThrownItemEntity> entityType, World world) {
        super(entityType, world);
    }

    public ReallyLDEntity(LivingEntity livingEntity, World world) {
        super(ModEntities.ReallyLD, livingEntity, world);
    }

    @Override
    protected Item getDefaultItem() {
        return ModItems.REALLYTHELASTSWORDYOUWILLEVERNEED;
    }
    ...
    protected void onEntityHit(EntityHitResult entityHitResult) {
        if(!this.getWorld().isClient()){
            ...
            entity.damage(this.getDamageSources().thrown(this, entity2), 7999999874453995500f);
