...
public abstract class NeoForgeCustomTabTextureMixin {
    @Unique
    ...
    private ResourceLocation redirectTabTexture(ResourceLocation original,
        ...
        if (tab == ModItemGroupsNeoForge.the_last_sword_you_will_ever_need.get()) {
    ...
    private void redirectScroller(GuiGraphics graphics, ResourceLocation original, int x, int y, int width, int height) {
        if (selectedTab == ModItemGroupsNeoForge.the_last_sword_you_will_ever_need.get()) {
